...
const PROVIDER_ID = 'trustfoundry-legal-search';
...
function configuredModelType(config = {}, benchmarkCase = null) {
  ...
  if (typeof modelType !== 'string' || !modelType.trim()) {
    throw new Error(
      'trustfoundry-legal-search requires provider config model_type or row metadata.model_type'
    );
  }
...
export const trustfoundryLegalSearchProviderAdapter = {
  id: 'trustfoundry-legal-search',
  version: 'trustfoundry-legal-search-provider-v1',
