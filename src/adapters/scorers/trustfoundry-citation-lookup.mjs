...
// `manifest.scorer.config`, then defaults. Same layered lookup as trustfoundry-legal-search.
...
export const trustfoundryCitationLookupScorerAdapter = {
  id: SCORER_ID,
  version: VERSION,
  ...
  // Streaming variant. Matches the shape used by trustfoundry-legal-search — the runner
