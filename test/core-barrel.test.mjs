...
test('core barrel exposes the new Phase 2 helpers', () => {
  ...
  assert.equal(typeof core.retryFailedRun, 'function');
  assert.equal(typeof core.retryFailed, 'function');
  assert.equal(typeof core.defaultRetryFilter, 'function');
  assert.equal(typeof core.isMissScore, 'function');
  assert.equal(typeof core.casesForRetrySelection, 'function');
  assert.equal(typeof core.buildReport, 'function');
  assert.equal(typeof core.executeProviderCaseWithRetry, 'function');
  assert.equal(typeof core.summarizeTokenUsage, 'function');
  assert.equal(typeof core.normalizeTokenUsage, 'function');
  assert.equal(typeof core.writeCaseCheckpoint, 'function');
  assert.equal(typeof core.loadCaseCheckpoints, 'function');
  assert.equal(typeof core.writeCaseProgressCheckpoint, 'function');
  assert.equal(typeof core.clearCheckpoints, 'function');
